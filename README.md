...
This includes official code, model checkpoints, and training data from RAGnRoll: Learning to Iteratively Retrieve and Generate Attributable Answer Snippets (ACM TOIS)
 ...
 [13B Trained Model]() | [Paper](https://akariasai.github.io/files/adaptive_retrieval_augmented_lm_arxiv.pdf) | [Synthetic Training data](https://huggingface.co/datasets/AttriRAG/ragnroll_train_data_hagrid_seg_proba) | 
